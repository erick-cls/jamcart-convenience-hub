    ...
    <>
      ...
      <div className="pt-28 pb-16 bg-black">
        <div className="app-container">
          ...
          >
            <h1 className="text-4xl font-bold mb-8 text-center text-[#fced87]">About JAMCart</h1>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm mb-8">
              ...
              <p className="text-gray-700">
                Founded in 2025 by Daraine Delevante, JAMCart has quickly grown to become the go-to platform for quick deliveries and services across multiple categories, from groceries to bill payments.
              </p>
            </div>
